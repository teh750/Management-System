...
namespace Pharmacy_Management_System {
    ...
    public partial class PharmacyDataSet : global::System.Data.DataSet {
        ...
        public partial class ProductDataTable : global::System.Data.TypedTableBase<ProductRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ProductRow AddProductRow(string Name, string Type, string Purpose, System.DateTime Date) {
...
namespace Pharmacy_Management_System.PharmacyDataSetTableAdapters {
    ...
    public partial class ProductTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Product` WHERE ((`ID` = ?) AND ((? = 1 AND `Name` IS NULL) OR (`Name" +
                "` = ?)) AND ((? = 1 AND `Type` IS NULL) OR (`Type` = ?)) AND ((? = 1 AND `Purpos" +
                "e` IS NULL) OR (`Purpose` = ?)) AND ((? = 1 AND `Date` IS NULL) OR (`Date` = ?))" +
                ")";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Product` (`Name`, `Type`, `Purpose`, `Date`) VALUES (?, ?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Product` SET `Name` = ?, `Type` = ?, `Purpose` = ?, `Date` = ? WHERE ((`ID` = ?) AND ((? = 1 AND `Name` IS NULL) OR (`Name` = ?)) AND ((? = 1 AND `Type` IS NULL) OR (`Type` = ?)) AND ((? = 1 AND `Purpose` IS NULL) OR (`Purpose` = ?)) AND ((? = 1 AND `Date` IS NULL) OR (`Date` = ?)))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Name, Type, Purpose, [Date] FROM Product";
        ...
        public virtual int Delete(int Original_ID, string Original_Name, string Original_Type, string Original_Purpose, global::System.Nullable<global::System.DateTime> Original_Date) {
        ...
        public virtual int Insert(string Name, string Type, string Purpose, global::System.Nullable<global::System.DateTime> Date) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, string Type, string Purpose, global::System.Nullable<global::System.DateTime> Date, int Original_ID, string Original_Name, string Original_Type, string Original_Purpose, global::System.Nullable<global::System.DateTime> Original_Date) {
            if ((Name == null)) {
    ...
    public partial class UserTableAdapter : global::System.ComponentModel.Component {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(PharmacyDataSet.UserDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual PharmacyDataSet.UserDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            PharmacyDataSet.UserDataTable dataTable = new PharmacyDataSet.UserDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(PharmacyDataSet.UserDataTable dataTable) {
            return this.Adapter.Update(dataTable);
        }
